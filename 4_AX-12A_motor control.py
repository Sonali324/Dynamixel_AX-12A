...
while 1:
    ...
    while 1:
        ...
        print("[ID:%03d] GoalPos:%03d  PresPos:%03d" % (DXL2_ID, dxl_goal_position[index], dxl_present_position))
        ...
        print("[ID:%03d] GoalPos:%03d  PresPos:%03d" % (DXL3_ID, dxl_goal_position[index], dxl_present_position))
        ...
        print("[ID:%03d] GoalPos:%03d  PresPos:%03d" % (DXL4_ID, dxl_goal_position[index], dxl_present_position))
